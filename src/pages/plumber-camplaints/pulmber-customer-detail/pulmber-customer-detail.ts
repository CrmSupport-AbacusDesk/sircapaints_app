...
export class PulmberCustomerDetailPage {
  ...
  getDirection()
  {
    ...
    this.geolocation.getCurrentPosition().then((resp) => {
      ...
      console.log(resp.coords.latitude, 'line number 103');
      console.log(resp.coords.longitude, 'line number 104');
      console.log('====================================');
      ...
      this.launchNavigator.navigate(this.plumber_detail.cust_lat+','+this.plumber_detail.cust_long, options)
        .then(
          ...
          error => console.log('Error launching navigator line number 119', error)
        );
  });
