...
export class DealerProfilePage {
    ...
    get_details()
    {
        ...
        this.dbService.onPostRequestDataFromApi({"dr_id":this.id,"type":this.type},"dealerData/getdetails", this.dbService.rootUrlSfa)
        .subscribe(resp=>{
            console.log(resp);
            this.data = resp;
    ...
    {
        console.log(this.data);
        this.dbService.onPostRequestDataFromApi({"data":this.data},"dealerData/update_user_bank_detail", this.dbService.rootUrlSfa)
        .subscribe(resp=>{
            console.log(resp);
            if(resp)
            {
